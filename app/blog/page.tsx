                ...
                <div className="container px-4 md:px-6 mx-auto relative">
                    <div className="max-w-4xl">
                        ...
                        <h1 className="text-5xl md:text-7xl font-black text-white mb-8 leading-tight tracking-tighter">
                            Блог и <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500">Новости</span>
                        </h1>
                        <p className="text-xl md:text-2xl text-slate-400 leading-relaxed font-medium max-w-2xl">
                            Актуальные статьи о развитии недвижимости, маркетинге и современных технологиях для успеха вашего бизнеса.
                        </p>
                    </div>
                </div>
            </section>
                                    ...
                                    <div className={`h-64 w-full relative ${item.data.imageGradient || 'bg-slate-900'} overflow-hidden`}>
                                        {item.data.image ? (
                                            ...
                                            <div className="absolute inset-0 flex items-center justify-center p-8 text-center">
                                                <span className="text-2xl font-black text-white/10 group-hover:text-white/20 transition-colors uppercase tracking-widest">Blog</span>
                                            </div>
                                        )}
                                        ...
                                        <div className="absolute bottom-0 left-0 w-full p-6 bg-gradient-to-t from-slate-950 to-transparent">
                                            <div className="flex items-center gap-2 text-blue-400 font-black text-[10px] uppercase tracking-[0.2em]">
                                                ...
                                                {item.data.publishedAt ? new Date(item.data.publishedAt).toLocaleDateString('ru-RU') : '2025'}
                                            </div>
                                        </div>
                                    </div>
                    ...
                    {posts.length === 0 && (
                        <div className="text-center py-40 border-2 border-dashed border-white/5 rounded-[3rem]">
                            ...
                            <p className="text-slate-500 max-w-sm mx-auto">
                                Мы готовим полезные материалы о развитии недвижимости и маркетинге. Заходите позже!
                            </p>
                        </div>
                    )}
                </div>
